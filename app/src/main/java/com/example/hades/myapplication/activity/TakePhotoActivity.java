...
import com.example.hades.myapplication.adapter.PhotoFiltersAdapter;
import com.example.hades.myapplication.view.RevealBackgroundView;
...
public class TakePhotoActivity extends BaseActivity implements RevealBackgroundView.OnStateChangeListener,CameraHostProvider {
    ...
    public  void onAcceptClick(){
        PulishActivity.openWithPhotoUri(this, Uri.fromFile(photoPath));
    }
